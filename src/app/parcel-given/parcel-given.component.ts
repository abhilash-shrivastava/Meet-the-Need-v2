...
@Component({
    selector: 'parcel-given',
    templateUrl: './parcel-given.component.html',
    styleUrls: ['./parcel-given.component.css'],
    providers: [PaginationService, RequestsService, Panel, GoogleApiService],

})

export class ParcelGivenComponent{
    profile: any;
    parcelRequests: any;
    errorMessage: string;
    showDetails = false;
    ...
    ngOnInit(){
        ...
        this.profile.status = 'Assigned To Service Provider';
