...
@Component({
    selector: 'all-receiver-requests',
    templateUrl: './all-receiver-requests.component.html',
    styleUrls: ['./all-receiver-requests.component.css'],
    providers: [PaginationService, RequestsService, Panel, GoogleApiService],

})

export class AllReceiverRequestsComponent{
